...
<div class="container-fluid h-100">
        ...
        <div class="col-lg-6 col-md-6 d-none d-sm-block d-md-block position-relative"
            ...
            <div class="col-12 col-md-6 col-lg-6 py-4 px-2 bg-grey-light-color position-relative d-flex align-items-center">
                    ...
                    <form action="" class="d-flex flex-column align-items-center w-100">
                        ...
                        <div class="card shadow col-11 col-lg-10 col-md-10 bg-grey-light-color">
                            <div class="card-body rounded-3">
                                ...
                                <div class="form-group has-feedback">
                                    <label for="password" class="control-label fw-bold xtra-small-font">Password<span class="text-danger">*</span></label>
                                    <div class="input-group mb-2 ">
                                        <span class="input-group-text bg-grey-color"><i class="bi bi-lock-fill text-grey-color"></i></span>
                                        <input type="password" class="form-control bg-grey-color" placeholder="Masukan Password" id="password" />
                                        <span class="input-group-text bg-grey-color" id="togglePassword"><i class="bi bi-eye-slash-fill text-primary-color"></i></span>
                                    </div>
                                </div>        
                            </div>
                        </div>
                        <div class="col-11 col-lg-10 col-md-10 d-flex justify-content-between mt-3">
                            <div class="form-check">
                                <input class="form-check-input border-blue-color" type="checkbox" value="" id="invalidCheck">
                        ...
                        <div class="col-11 col-lg-10 col-md-10 mt-3">
                            ...
                            <a href="" class="btn bg-primary-color py-3 py-lg-2 text-light col-12 fw-bold" type="submit">Masuk</a>
                        </div>
                        <p class="mt-3">Belum Punya Akun ? <a href="register" class="border-primary-color py-1 px-1 rounded-3 text-decoration-none">Buat Akun</a></p>
                    </form>
