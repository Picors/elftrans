                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item active">Edit Data Mobil Elf</li>
                        </ol>
                    </div>
                    <div class="col-sm-12">
                        <div class="card text-dark bg-primary mt-3">
                            ...
                            <div class="card-body">
                                <h1 class="card-title fw-bold">Edit Data Mobil Elf</h1>
            ...
            <div class="container-fluid">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <!-- Form Edit Mobil Elf -->
                        <form action="{{ route('admin.mobil_elf.update', $mobilElf->id) }}" method="POST">
                            @csrf
                            @method('PUT')
                            <div class="mb-3">
                                <label for="nama" class="form-label">Nama Mobil</label>
                                <input type="text" class="form-control @error('nama') is-invalid @enderror"
                                    id="nama" name="nama" value="{{ old('nama', $mobilElf->nama) }}" required>
                                @error('nama')
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control @error('nama_sopir') is-invalid @enderror"
                                    id="nama_sopir" name="nama_sopir"
                                    value="{{ old('nama_sopir', $mobilElf->nama_sopir) }}" required>
                                @error('nama_sopir')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control @error('nohp_sopir') is-invalid @enderror"
                                    id="nohp_sopir" name="nohp_sopir"
                                    value="{{ old('nohp_sopir', $mobilElf->nohp_sopir) }}" required>
                                @error('nohp_sopir')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                                ...
                                <select class="form-select @error('id_jadwal_keberangkatan') is-invalid @enderror"
                                    ...
                                    @foreach ($jadwalKeberangkatan as $jadwal)
                                        <option value="{{ $jadwal->id }}"
                                            {{ old('id_jadwal_keberangkatan', $mobilElf->id_jadwal_keberangkatan) == $jadwal->id ? 'selected' : '' }}>
                            ...
                            <div class="mb-3">
                                ...
                                <select class="form-select @error('id_jadwal_kedatangan') is-invalid @enderror"
                                    ...
                                    @foreach ($jadwalKedatangan as $jadwal)
                                        <option value="{{ $jadwal->id }}"
                                            {{ old('id_jadwal_kedatangan', $mobilElf->id_jadwal_kedatangan) == $jadwal->id ? 'selected' : '' }}>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="number" class="form-control @error('harga') is-invalid @enderror"
                                    id="harga" name="harga" value="{{ old('harga', $mobilElf->harga) }}"
                                    step="0.01" required>
                                @error('harga')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
