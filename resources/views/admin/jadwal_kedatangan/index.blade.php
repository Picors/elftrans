...
@section('content')
                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item active">Data Jadwal Kedatangan</li>
                        </ol>
                    </div>
                    <div class="col-sm-12">
                        <div class="card text-dark bg-primary mt-3">
                            ...
                            <div class="card-body">
                                <h1 class="card-title fw-bold">Kelola Data Jadwal Kedatangan</h1>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="addForm" method="POST" action="{{ route('admin.jadwal_kedatangan.store') }}">
                        @csrf
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="time" class="form-control" id="jamBerangkat" name="jam_kedatangan" required>
                        </div>
                    </form>
                </div>
    ...
    <div class="modal fade" id="editModal" tabindex="-1" aria-labelledby="editModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header modal-header-custom">
                    <h5 class="modal-title" id="editModalLabel">Edit Jadwal Kedatangan</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <form id="editForm" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="time" class="form-control" id="editJamBerangkat" name="jam_kedatangan"
                                required>
                        </div>
                    </form>
                </div>
    ...
    <div class="modal fade" id="deleteModal" tabindex="-1" aria-labelledby="deleteModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header modal-header-custom">
                    <h5 class="modal-title" id="deleteModalLabel">Hapus Jadwal Kedatangan</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <p>Apakah Anda yakin ingin menghapus jadwal kedatangan ini?</p>
                </div>
                <div class="modal-footer modal-footer-custom">
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            $('#editModal').on('show.bs.modal', function(event) {
                ...
                modal.find('form').attr('action', '/admin/jadwal_kedatangan/' + id);
            });
